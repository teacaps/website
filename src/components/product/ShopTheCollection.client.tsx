...
export function ShopTheCollection({ collection }: { collection: CollectionFragment }) {
	return (
		<section className="mt-8 flex w-full flex-col items-center justify-center space-y-8 sm:mt-16 lg:flex-row lg:space-y-0 lg:space-x-12 xl:space-x-24">
			<h2 className="text-matcha text-xl leading-10 xs:text-2xl xl:text-3xl">Shop the Collection</h2>
			<div className="flex flex-wrap items-start justify-center last:pr-0 lg:justify-start">
