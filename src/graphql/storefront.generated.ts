...
export type PageQuery = {
	...
	urlRedirects: {
		__typename?: "UrlRedirectConnection";
		nodes: Array<{ __typename?: "UrlRedirect"; path: string; target: string }>;
	};
	page?: {
		__typename?: "Page";
		title: string;
...
export type ProductDetailsFragment = {
	...
	collections: {
		...
		nodes: Array<{
			...
			title: string;
			handle: string;
			isColorway?: { __typename?: "Metafield"; key: string; value: string } | null;
			products: {
				__typename?: "ProductConnection";
				nodes: Array<{
					__typename?: "Product";
...
export type ProductOverviewFragment = {
	__typename?: "Product";
	title: string;
	handle: string;
	availableForSale: boolean;
	...
	collections: { __typename?: "CollectionConnection"; nodes: Array<{ __typename?: "Collection"; id: string }> };
};
